...
The scripts were developed for Python 3.10 or later. The main required Python packages are:
...
If a `requirements.txt` file is provided in the repository, the environment can also be prepared with:
...
A permanent archival record will be provided through Zenodo after repository finalization.
